...
export function GlobalLoading() {
  ...
  useEffect(() => {
    ...
    // wait for all animations to finish and then set animating to false
    Promise.allSettled(
  ...
  return (
    ...
    >
      <div
        ref={ref}
        className={cx(
          "h-full bg-gradient-to-r from-primary-600 via-cyan-500 to-emerald-400 transition-all duration-500 ease-in-out",
