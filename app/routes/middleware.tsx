...
import { requireUser, requireOrganization, requireSubscription, getActiveOrganizationId } from "~/utils/auth.server";
...
export async function loader({ request, params }: LoaderFunctionArgs) {
  ...
  throw redirect(ROUTES.DASHBOARD(firstOrg.slug));
}
